...
class _ArchivedClientsScreenState extends State<ArchivedClientsScreen> {
  ...
  void _showClientDialog(BuildContext context, Color primary, Client client) {
    final nomeCtrl     = TextEditingController(text: client.nome);
    final cognomeCtrl  = TextEditingController(text: client.cognome);
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () async {
              if (nomeCtrl.text.trim().isEmpty || cognomeCtrl.text.trim().isEmpty) return;
            ...
            children: [
              ...
              if ((client.note ?? '').isNotEmpty) ...[
                ...
                Text('Note', style: TextStyle(fontSize: 11,
                    fontWeight: FontWeight.w700, color: Colors.grey[500], letterSpacing: 0.8)),
        ...
        children: [
          ...
          Padding(
            ...
            child: Row(
              ...
              children: [
                Text(
                  '${_filtered.length} client${_filtered.length == 1 ? 'e' : 'i'} archivia${_filtered.length == 1 ? 'to' : 'ti'}',
                                ...
                                children: [
                                  Row(children: [
                                    ...
                                    Container(
                                      ...
                                      child: Text('ARCHIVIATO', style: TextStyle(
                                  ...
                                  if ((client.email ?? '').isNotEmpty)
                                    Row(children: [
                                      ...
                                      Flexible(child: Text(client.email!,
